...
public abstract class AbstractAmqpController<T extends AbstractEvent<?>> {
  ...
  public void publish(final T event) {
    log.debug("Sending the {}, generated by {}. ", event.getClass().getName(), event.getContext());
  ...
  public void publish(final T event, final Integer priority) {
    log.debug("Sending the {}, generated by {} with priority {}. ", event.getClass().getName(), event.getContext(), priority);
